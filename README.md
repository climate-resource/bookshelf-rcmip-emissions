...
Emissions of greenhouse gases and air pollutants from RCMIP, for use in climate models.
...
```bash
   make run VERSION=v5.1.0
```

`VERSION` picks one entry from `books:` in the recipe.
The result lands in `bundle/v5.1.0` and is then validated.
